...
<head>
    ...
    position: fixed;
    bottom: 20px;
    right: 20px;  /* DARI kiri → pindah ke kanan */
    
    padding: 8px 14px; /* DIPERKECIL */
    background: rgba(0,0,0,0.55);
    color: #cfa35e;
    border: 1px solid #cfa35e; /* DIPERKECIL */
    font-family: 'Cinzel', serif;
    font-size: 11px;  /* DIPERKECIL */
    letter-spacing: 1px; /* DIPERKECIL */
...
#sound-btn:hover {
    ...
    box-shadow: 0 0 8px rgba(207,163,94,0.4);
}
