    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; user-select: none; }
        ...
        .bg-image {
            ...
            object-fit: cover;
            /* Menggunakan gambar asset GOW3.jpg milikmu sebagai background */
            background-image: url('asset/GOW3.jpg'); 
        ...
        .section-hero {
            width: 100%; 
            min-height: 85vh; /* Tinggi minimal agar tidak gepeng */
            display: flex; flex-direction: column; 
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="section-content">
            <h1 class="page-title reveal-vision" style="font-size: 2.5rem;">THE VISION</h1>
        ...
        <div class="section-content" style="padding-top: 0;">
            <h1 class="page-title reveal-tech" style="font-size: 2.5rem;">THE ARSENAL</h1>
